...
export class UserHomeComponent implements OnInit {
  ...
  fetchJobs() {
    this.http.get<{ jobs: Job[] }>('https://jobsphere-backend-zja7.onrender.com/api/get-jobs').subscribe({
      next: (response) => {
  ...
  applyToJob(job: Job) {
    ...
    this.http.post('https://jobsphere-backend-zja7.onrender.com/api/apply-job', applyData).subscribe({
      next: (response) => {
